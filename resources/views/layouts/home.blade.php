...
<head>
	...
	<meta name="base_url" content="{{ App::make('url')->to('/') }}">
	@guest
								...
								<ul class="media-list dropdown-content-body">
									...
									<li class="media">
										...
										<div class="media-body">
											...
											<span class="text-muted">What a strenuous career it is that I have chosen...</span>
										</div>
									</li>
					...
					<div class="page-header page-header-default">
						<div class="page-header-content">
							<div class="page-title">
								<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Blog</span> - Grid</h4>
							</div>
